/* All the time we do code changes. The best code is one changes the minimum.
    We got a request to remove the 3 integers and replace with in total_seconds.
        Do necessary codeing changes.
    Identify one good coding tip if was applied in this code will make us change less code.
*/
